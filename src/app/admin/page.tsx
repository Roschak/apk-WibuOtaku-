        ...
        <div className="space-y-8 pb-6">
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {[
                    ...
                    <Surface key={label} className="space-y-3">
                ...
                <Surface className="space-y-5">
                    ...
                    <div className="space-y-3">
                        {releaseSources.map((source) => (
                            <div key={source.name} className="rounded-3xl border border-white/10 bg-black/18 p-4">
                ...
                <Surface className="space-y-5">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={item} className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm leading-7 text-white/72">
                                {item}
                            </div>
                        ))}
                    </div>
